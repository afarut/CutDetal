...
from .serializers import DetailSerializer, OrderCreateSerializer, MaterialSerializer, MaterialEditSerialazer, DetailWithOrderStatus, RangeSerialazer, DetailSaveSerialazer, DXFSizeSerialazer, ThicknessSerialazer
from .models import Detail, Order, Material, Range, DXFSize, Thickness
