...
const MonitoringFilter = ({ isCalculationsChosen, selectedOption, setSelectedOption }) => {
  return (
    <div
    ...
    >
      ...
      <div className="relative">
        ...
        >
          ...
          <option hidden={isCalculationsChosen} value={"?ordering=count"}>Количество</option>
          <option value={"?ordering=-date"}>Дата</option>
          <option hidden={isCalculationsChosen} value={"?ordering=price"}>Цена</option>
          <option hidden={isCalculationsChosen} value={"?ordering=material"}>Материал</option>
        </select>
